    ...
    <ForumShell currentSection="users">
      ...
      <section className="border-b-[0.25px] border-[var(--jr-border)] px-4 py-4">
        ...
        <div className="mt-4 grid grid-cols-3 gap-4 text-sm">
          <div className="rounded-[8px] border-[0.25px] border-[var(--jr-border)] bg-[var(--jr-surface-alt)] p-4">
        ...
        <div className="mt-4 space-y-4">
          {activity.questions.length ? (
            activity.questions.map((question) => (
              <article
                key={question.id}
                className="rounded-[8px] border-[0.25px] border-[var(--jr-border)] bg-[var(--jr-surface-alt)] p-4"
              >
